...
if __name__ == "__main__":
    ...
    parser.add_argument('--smooth_scores', default=True, action='store_true', help='option for smoothing scores (ewma)')
    ...
    parser.add_argument("--min_anomaly_rate", default=0.0005, type=float, help='minimum threshold rate')
